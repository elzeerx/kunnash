...
(function (root, factory) {
  ...
  const S = {
    ...
    modelChipTitle: ['تغيير النموذج من الإعدادات', 'Change the model in Settings'],
    send:         ['إرسال', 'Send'],
    ...
    refreshModels: ['↻ القائمة', '↻ List'],
    refreshTitle:  ['جلب قائمة النماذج من الخدمة', 'Fetch the model list from the service'],
