...
(function (root, factory) {
  ...
  const S = {
    ...
    forgetWs:       ['أزل الوصول لهذا المجلد', 'Remove access to this folder'],
    forgetWsConfirm: ['إزالة الوصول إلى «{name}»؟ ملفاتك تبقى مكانها — يُسحب اختيار المجلد فقط، والعودة إليه لاحقًا تجد كل شيء كما كان.',
                      'Remove access to “{name}”? Your files stay put — only the folder selection is withdrawn; reopening it later finds everything as it was.'],
