...
// تسقط بينهما. التطبيع يزيل التشكيل ويوحّد الألف والياء والتاء المربوطة.
...
function matchSkill(root, userText) {
  ...
  for (const s of skills) {
    const trigger = triggersOf(s).find((t) => text.includes(t));
...
module.exports = { matchSkill, triggersOf, normalize, skillMessage };
