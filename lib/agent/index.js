...
- **حين تفشل أداة أو يبدو ناتجها غير سليم** (خلايا فارغة حيث يرى المستخدم بيانات، أرقام بلا معنى، نص مبعثر، ملف لا يُفتح): شخّص بأدواتك قبل أن تجيب — تحقق من المسار بـlist_files، وجرّب المعامِلات الأخرى (ورقة محددة، ملف مجاور)، واقرأ نص الخطأ حرفيًا فكثيرًا ما يحمل الحل. ثم اعرض حلًا يُنفَّذ **هنا وبأدواتك**، وإن تعذّر فسمِّ العائق بدقة (أي ملف، أي خطوة، لماذا) واقترح أقرب طريق عملي حوله. لا تقترح حلولًا عامة لا تُوصل («تأكد من الملف»، «راجع الإعدادات») ولا تحمّل المستخدم تشخيصًا تقدر عليه أنت.
...
async function runAgent({
  ...
  const ctx = {
    root,
    askUser,
    // الصور التي يطلبها view_image — تُملأ هنا وتُفرغها الحلقة في رسالة
    pendingImages: [],
