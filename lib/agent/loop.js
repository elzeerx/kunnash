...
async function runLoop(o) {
  ...
  const closers = {
    ...
    time: `\n\n**توقّفت عند حدّ الوقت** (${mins} دقيقة) والمهمة لم تكتمل. قل «أكمل» لأتابع.`,
    tokens: `\n\n**توقّفت عند حدّ الرموز** والمهمة لم تكتمل. قل «أكمل» لأتابع من حيث وقفت.`,
    cost: `\n\n**توقّفت عند حدّ الكلفة**: أنفق هذا التشغيل ${spent} وحدُّه ${limits.costUsd}$ للتشغيل الواحد — حارسٌ يمنع طلبًا واحدًا من استنزاف رصيدك.\n\nالمهمة لم تكتمل. قل «أكمل» فأتابع من حيث وقفت بميزانية جديدة، أو اطلب نموذجًا أرخص للمهام الطويلة.`,
  };
