...
async function chatSend({ sessionId, text, attachments, retry, requestId }, emit, onPermission, askUser) {
  ws.requireWorkspace();
...
module.exports = {
  PRESETS,
  loadProfile, saveProfile, connectionServices,
